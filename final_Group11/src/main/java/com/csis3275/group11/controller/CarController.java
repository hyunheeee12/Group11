...
//		model.addAttribute("newCar", new Car());
	...
	{
		if(newCar.getMake().equals("") || newCar.getMake()==null||newCar.getModel().equals("") || newCar.getModel()==null||newCar.getYearMade().equals("") || newCar.getYearMade()==null||newCar.getColor().equals("") || newCar.getColor()==null||newCar.getPrice() == 0.0)
