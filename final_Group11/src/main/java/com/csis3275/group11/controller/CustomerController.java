...
public class CustomerController 
{
	...
	public String register(@ModelAttribute("nCustomer") Customer newCustomer, BindingResult result)
    {
		...
		if(newCustomer.getfName().equals("")||newCustomer.getlName().equals("")||newCustomer.getEmail().equals("")||newCustomer.getLicence().equals("")||newCustomer.getPassword().equals("") || !(customerService.findByLicence(newCustomer.getLicence())==null)|| !(customerService.findByEmail(newCustomer.getEmail())==null))
			{
				//(customerService.findByLicence(newCustomer.getLicence());
				return  "/register";}
		else {
